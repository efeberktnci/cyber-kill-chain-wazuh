...
Cross-scenario reporting belongs here. Scenario-specific incident reports remain inside their scenario directories to preserve case context.

## Phase Index

| Phase | Status | Report Folder |
|---|---|---|
| Phase 1 - Reconnaissance | :white_check_mark: Ready for future summary reporting | [`phase-01-reconnaissance/README.md`](phase-01-reconnaissance/README.md) |
